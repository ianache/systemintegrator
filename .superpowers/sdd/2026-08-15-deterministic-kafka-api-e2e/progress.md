...
Task 2: minor (deferred): application module compiles sources from the legacy root layout; no functional blocker for this task.
Task 2: complete (commits 9a0fd0d..90571fb, review clean; Docker bootstrap blocked by environment)
Task 3: fix round 1/5 (1 addressed, 0 open; commits 6c979c8..048afd0)
Task 3: complete (commits 90571fb..048afd0, review clean)
