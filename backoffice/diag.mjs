...
// Navigate directly via URL instead of clicking, to avoid selector ambiguity
await page.goto('http://localhost:4200/integration/profiles', { waitUntil: 'networkidle', timeout: 30000 });
await page.waitForTimeout(1500);
console.log('URL:', page.url());
await page.screenshot({ path: `${OUT}\\diag-profiles.png`, fullPage: true });
